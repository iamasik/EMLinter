...
const PrivacyPolicyContent = () => (
    <>
        ...
        <h3>5. Contact Us</h3>
        <p>If you have any questions about this Privacy Policy, please get in touch via our <a href="#" onClick={(e) => { e.preventDefault(); (window as any).handleFooterNavigate('contact-us'); }}>Contact Us</a> page.</p>
    </>
);
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="md:col-span-1">
                            <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('home'); }} className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-pink-500 mb-4 inline-block">
                                EMLinter
                            </a>
