// FIX: Changed to safe initialization to prevent hot-reload errors which might cause the "no exported member" error.
...
// IMPORTANT: These variables must be set in your Vite .env file (e.g., VITE_FIREBASE_API_KEY="...").
...
// FIX: Rewrote initialization to a concise ternary operator to prevent hot-reload errors.
// This might help with module resolution issues in some environments.
