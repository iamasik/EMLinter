...
const FaqPage = () => {
    const faqs = [
        ...
        { q: "Who is this toolkit for?", a: <p>EMLinter is for everyone involved in the email creation process. It's perfect for marketers and content managers who need to edit templates without code, designers striving for pixel-perfect rendering, and developers who want a faster, error-free workflow. It's an ideal toolkit for individuals and teams alike.</p> },
        { q: "Is EMLinter free to use?", a: <p>Yes, all tools on EMLinter are currently free to use. We are supported by community contributions. If you find the tools helpful, please consider supporting the project.</p> },
        { q: "Is my code and data safe?", a: <p>Absolutely. EMLinter operates entirely within your browser. Your HTML code, templates, and any edits you make are processed locally on your computer. They are never sent to, or stored on, our servers, ensuring your data remains private and secure.</p> },
        { q: "What kind of errors does the linter find?", a: <p>Our <a href="/tools/code-fix" className="text-pink-400 hover:underline">HTML Email Linter</a> is specifically designed to find issues common in email development. This includes unclosed or mismatched tags, missing attributes, broken image links, and CSS properties that are poorly supported in major email clients, especially different versions of Outlook.</p> },
        { q: "How do I make my template editable in the Visual Editor (Vibe)?", a: <p>It's simple! You just need to add specific CSS classes to your HTML elements. For example, add <code>vibe-section</code> to a <code>&lt;tr&gt;</code> to make it a movable/duplicatable section, <code>vibe-text</code> to an element containing text, and <code>vibe-img</code> to an <code>&lt;img&gt;</code> tag. We provide a full guide on our <a href="/resources/how-it-works" className="text-pink-400 hover:underline">How It Works</a> page.</p> },
        { q: "Why are there special tools for Outlook?", a: <p>Microsoft Outlook uses Microsoft Word's rendering engine for emails, which has many quirks and poor support for modern HTML/CSS standards. Our <a href="/solutions/outlook-button-generator" className="text-pink-400 hover:underline">Outlook Tools</a> generate VML (Vector Markup Language) code, a Microsoft-specific language that provides a reliable fallback for things like rounded buttons and background images, ensuring they look great in all Outlook versions.</p> },
        { q: "Can I use the templates for commercial projects?", a: <p>Yes! All templates in our <a href="/templates" className="text-pink-400 hover:underline">Template Library</a> are free to download and use for both personal and commercial projects without attribution.</p> },
    ];
    ...
    return (
        <div>
            ...
            <header className="text-center mb-12">
                ...
                <p className="text-gray-400 mt-2 max-w-2xl mx-auto">Find answers to common questions about our tools and services.</p>
            </header>
