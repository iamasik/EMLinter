                    ...
                    <div className="opacity-0 animate-enter" style={{ animationDelay: '400ms' }}>
                        <div className="relative p-8 h-full rounded-2xl bg-gray-800/50 border border-gray-700/50 overflow-hidden transform transition-transform duration-300 hover:-translate-y-2">
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                ...
                                {loading ? (
                                    <div className="mt-auto flex justify-center flex-wrap gap-3 animate-pulse">
                                        <div className="h-8 w-20 bg-gray-700 rounded-full"></div>
                                        <div className="h-8 w-20 bg-gray-700 rounded-full"></div>
                                        <div className="h-8 w-20 bg-gray-700 rounded-full"></div>
                                    </div>
                                ) : socials.length > 0 ? (
                                    <div className="mt-auto flex justify-center flex-wrap gap-3">
                                        {socials.map((social) => (
                                            <a
                                                key={social.name}
                                                href={social.url}
                                                ...
                                                className="px-4 py-2 text-sm font-semibold bg-gray-700 text-gray-200 rounded-full hover:bg-gray-600 hover:text-white transition-colors duration-200"
                                            >
                                                {social.name}
                                            </a>
                                        ))}
                                    ...
                                    <div className="mt-auto text-center">
                                        <p className="text-sm text-gray-500">
                                            Social media links are currently unavailable.
                                        </p>
                                    </div>
                                )}
                            </div>
