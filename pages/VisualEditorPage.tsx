...
import { InfoIcon, CodeIcon, DownloadIcon, AlertTriangleIcon, SaveIcon, SpinnerIcon, CheckCircleIcon, TrashIcon, DesktopIcon, MobileIcon, ImageIcon, BriefcaseIcon, CloseIcon, UploadIcon } from '../components/Icons';
