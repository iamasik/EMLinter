...
const PostCard: React.FC<{ post: Post; onNavigate: (page: string) => void; }> = ({ post, onNavigate }) => {
    return (
        <div 
...
const RecommendedPostsSidebar: React.FC<{ posts: Post[], onNavigate: (page: string) => void, loading: boolean }> = ({ posts, onNavigate, loading }) => (
