...
const TemplateCard: React.FC<{ template: Template, onNavigate: (page: string, state?: any) => void }> = ({ template, onNavigate }) => {
  return (
    <div 
...
const TemplatesPage = ({ onNavigate, initialFilter }: { onNavigate: (page: string, state?: any) => void, initialFilter: any | null }) => {
