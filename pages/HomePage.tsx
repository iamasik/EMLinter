...
const FaqItem: React.FC<{ q: string, a: React.ReactNode, onNavigate: (page: string) => void }> = ({ q, a, onNavigate }) => {
...
const HomePage = ({ onNavigate }: { onNavigate: (page: string) => void }) => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            a: <p>Yes! We have a growing <a href="#" data-page="templates" className="text-pink-400 hover:underline">Template Library</a> of professionally designed, responsive HTML email templates. They are fully compatible with our tools and ready to be customized for your next campaign.</p>
        },
        {
            q: "How do I make my template editable in the Visual Editor?",
            a: <p>It's simple! You just need to add specific CSS classes like <code>vibe-section</code>, <code>vibe-text</code>, and <code>vibe-img</code> to your HTML elements. We provide a full guide on how to prepare your templates. Visit our <a href="#" data-page="how-it-works" className="text-pink-400 hover:underline">How It Works</a> page for a detailed walkthrough.</p>
        }
    ];
