...
const RecommendedPostsSidebar: React.FC<{ posts: Post[], currentPostId: string, onNavigate: (page: string) => void, loading: boolean }> = ({ posts, currentPostId, onNavigate, loading }) => (
        ...
        const fetchPostData = async () => {
            try {
                ...
                if (fetchedPost) {
                    ...
                    if (metaDesc && fetchedPost.seoMetaDescription) {
                        metaDesc.setAttribute('content', fetchedPost.seoMetaDescription);
                    }
                } else {
